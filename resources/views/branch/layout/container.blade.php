            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
                    ...
                    <ul class="kt-menu__nav ">
                        <li class="kt-menu__item  @if(Request::is('branch/home*') ) kt-menu__item--active @endif"
                            aria-haspopup="true">
                            <a href="{{ route('branch.home') }}" class="kt-menu__link ">
                                <i class="kt-menu__link-icon flaticon2-protection"></i>
                                <span class="kt-menu__link-text">{{ t('Dashboard') }}</span>
                            </a>
                        </li>
                        @can('Branches')
                            <li class="kt-menu__item  @if(Request::is('branch/branch*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('branch.branch.index')}}" class="kt-menu__link ">
                        ...
                        @canany(['Meals Categories', 'Meals'])
                            <li class="kt-menu__item kt-menu__item--submenu   @if(Request::is('branch/classification*') ) kt-menu__item--active @endif @if(Request::is('branch/meal*') ) kt-menu__item--active @endif"
                                    ...
                                    <ul class="kt-menu__subnav">
                                        ...
                                        @can('Meals Categories')
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="{{route('branch.classification.index')}}"
                                        ...
                                        @can('Meals')
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="{{route('branch.meal.index')}}" class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        ...
                        @canany(['Users', 'Drivers'])
                            <li class="kt-menu__item kt-menu__item--submenu   @if(Request::is('branch/users*') ) kt-menu__item--active @endif @if(Request::is('branch/drivers*') ) kt-menu__item--active @endif"
                                aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                    <span class="kt-menu__link-icon">
                                ...
                                <div class="kt-menu__submenu " kt-hidden-height="200"
                                    ...
                                    <ul class="kt-menu__subnav">
                                        ...
                                        @can('Drivers')
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="{{route('branch.driver.index')}}" class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        ...
                        @endcanany
                        @can('Orders')
                            <li class="kt-menu__item  @if(Request::is('branch/order*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('branch.order.index')}}" class="kt-menu__link ">
                        ...
                        {{--                                        @can('Branch Ratings')--}}
                        {{--                                            <li class="kt-menu__item " aria-haspopup="true"><a--}}
                        {{--                                                    href="{{route('branch.client_order_rate.index')}}"--}}
                        {{--                                                    class="kt-menu__link "><i--}}
                        ...
                        {{--                                        @can('Driver Ratings')--}}
                        {{--                                            <li class="kt-menu__item " aria-haspopup="true"><a--}}
                        {{--                                                    href="{{route('branch.client_driver_rate.index')}}"--}}
                        {{--                                                    class="kt-menu__link "><i--}}
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                ...
                <div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
                    <div id="kt_header_menu"
                        ...
                        <ul class="kt-menu__nav ">
                            ...
                            {{--                            @can('Payments')--}}
                            {{--                                <li class="kt-menu__item  @if(Request::is('branch/payment*') ) kt-menu__item--active @endif"--}}
                            {{--                                    aria-haspopup="true">--}}
                            {{--                                    <a href="{{route('branch.payment.index')}}" class="kt-menu__link ">--}}
                ...
                <div class="kt-header__topbar">
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim">
                            <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                <li class="kt-nav__item kt-nav__item--active">
                                    <a href="{{ route('branch.switch-language', 'en') }}" class="kt-nav__link">
                                ...
                                <li class="kt-nav__item">
                                    <a href="{{ route('branch.switch-language', 'ar') }}" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img
                    ...
                    @php
                        $notifications = \App\Models\Notification::query()->where(function ($query){
                            ...
                            })->where('notifiable_type', \App\Models\branch::class)
                                        ...
                                        <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll"
                                            ...
                                            @isset($notifications)
                                                @foreach($notifications as $notification)
                                                    <a href="{{ url('/branch/notification/'.$notification->id) }}"
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        ...
                        <div
                            ...
                            <div class="kt-notification">
                                <a href="{{route('branch.profile.show')}}" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
                                ...
                                <div class="kt-notification__custom kt-space-between">
                                    <form id="logout-form" action="{{ url("/branch/logout") }}" method="POST"
                                          style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                    <a href="{{ url("/branch/logout") }}" onclick="event.preventDefault();
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                ...
                <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                    @if(!Request::is('branch/home'))
                        <div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="{{ url('/branch/home') }}">{{ t('Home') }}</a>
                                </li>
                                @stack('breadcrumb')
                            </ul>
                        </div>
...
<div class="modal fade" id="sendNotification" tabindex="-1" role="dialog" aria-labelledby="sendNotification"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('branch.notification.store') }}">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="recipients" class="form-control" id="notification_type">
                            ...
                            {{--                            <option value="3">{{ t('branchs') }}</option>--}}
                            <option selected value="{{DRIVERS}}">{{ t('Drivers') }}</option>
                        </select>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function notifyMe(notify) {
        ...
        $('#notification_list').prepend(" <a href=\"/branch/notification/" + notify.id + "\"\n" +
            "                                                   class=\"kt-notification__item\">\n" +
            "                                                    <div class=\"kt-notification__item-icon\">\n" +
            "                                                        <i class=\"flaticon2-notification kt-font-success\"></i>\n" +
            "                                                    </div>\n" +
    ...
    // var channel = pusher.subscribe('branchs');
    // channel.bind('branch-notification', call_back);

    {{--var user_channel = pusher.subscribe('user_{{auth()->user()->id}}');--}}
    {{--user_channel.bind('branch-notification', call_back);--}}
