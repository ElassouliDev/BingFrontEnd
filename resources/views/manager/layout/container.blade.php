            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
                    ...
                    <ul class="kt-menu__nav ">
                        ...
                        @canany(['Restaurants', 'Merchant Types'])
                            <li class="kt-menu__item kt-menu__item--submenu   @if(Request::is('manager/restaurant*') ) kt-menu__item--active @endif @if(Request::is('manager/category*') || Request::is('manager/merchant_type*') ) kt-menu__item--active @endif"
                                aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                    <span class="kt-menu__link-icon">
                                        <i class="kt-menu__link-icon flaticon2-shopping-cart-1"></i>
                                    </span>
                                    <span class="kt-menu__link-text">{{t('Merchants')}}</span>
                                    ...
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
                                                class="kt-menu__link"><span
                                                    class="kt-menu__link-text">{{t('Restaurants')}}</span></span></li>
                                        @can('Restaurants')
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="{{route('manager.restaurant.index')}}" class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                        class="kt-menu__link-text">{{ t('Merchants') }}</span></a></li>
                                        @endcan


                                        @can('Merchant Types')
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="{{route('manager.merchant_type.index')}}"
                                                    class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                        class="kt-menu__link-text">{{ t('Merchants Types') }}</span></a>
                                            </li>
                                        @endcan
                                    </ul>
                                </div>
                        ...
                        @endcanany
                        @can('Branches')
                            <li class="kt-menu__item  @if(Request::is('manager/branch*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('manager.branch.index')}}" class="kt-menu__link ">
                        ...
                        @canany(['Meals Categories', 'Meals'])
                            <li class="kt-menu__item kt-menu__item--submenu   @if(Request::is('manager/classification*') ) kt-menu__item--active @endif @if(Request::is('manager/meal*') ) kt-menu__item--active @endif"
                                aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                    <span class="kt-menu__link-icon">
                                ...
                                <div class="kt-menu__submenu " kt-hidden-height="200"
                                    ...
                                    <ul class="kt-menu__subnav">
                                        ...
                                        @can('Meals Categories')
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="{{route('manager.classification.index')}}"
                                                    class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                        ...
                                        @can('Meals')
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="{{route('manager.meal.index')}}" class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                        ...
                        @endcanany
                        @can('Coupons')
                            <li class="kt-menu__item  @if(Request::is('manager/coupon*') ) kt-menu__item--active @endif"
                                aria-haspopup="true">
                                <a href="{{route('manager.coupon.index')}}" class="kt-menu__link ">
                                    <i class="kt-menu__link-icon flaticon2-gift-1"></i>
                                    <span class="kt-menu__link-text">{{ t('Coupons') }}</span>
                                </a>
                            </li>
                        @endcan
                        @can('Orders')
                            ...
                            <li class="kt-menu__item kt-menu__item--submenu   @if(Request::is('manager/classification*') ) kt-menu__item--active @endif @if(Request::is('manager/meal*') ) kt-menu__item--active @endif"
                                ...
                                <div class="kt-menu__submenu " kt-hidden-height="200"
                                    ...
                                    <ul class="kt-menu__subnav">
                                        ...
                                        @can('Branch Ratings')
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="{{route('manager.client_order_rate.index')}}"
                                                    class="kt-menu__link "><i
                                        ...
                                        @can('Driver Ratings')
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="{{route('manager.client_driver_rate.index')}}"
                                                    class="kt-menu__link "><i
                                        ...
                                        {{--                                        @can('Client Ratings')--}}
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="{{route('manager.driver_client_rate.index')}}"
                                                class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                    <span></span></i><span
                                                    class="kt-menu__link-text">{{ t('Client Ratings') }}</span></a></li>
                                        {{--                                        @endcan--}}
                                    </ul>
                                </div>
                            </li>
                        ...
                        @canany(['Packages', 'User Packages'])
                            <li class="kt-menu__item kt-menu__item--submenu   @if(Request::is('manager/package*') ) kt-menu__item--active @endif @if(Request::is('manager/user_package*') ) kt-menu__item--active @endif"
                                aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                    <span class="kt-menu__link-icon">
                                        <i class="kt-menu__link-icon flaticon2-soft-icons"></i>
                                ...
                                <div class="kt-menu__submenu " kt-hidden-height="200"
                                    ...
                                    <ul class="kt-menu__subnav">
                                        ...
                                        @can('User Packages')
                                            <li class="kt-menu__item " aria-haspopup="true"><a
                                                    href="{{route('manager.user_packages.index')}}"
                                                    class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                        class="kt-menu__link-text">{{ t('User Packages') }}</span></a>
                                            </li>
                                        @endcan
                                    </ul>
                                </div>
                ...
                <div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
                    <div id="kt_header_menu"
                        ...
                        <ul class="kt-menu__nav ">
                                    ...
                                    <span class="kt-menu__link-text">{{ t('Preview') }}</span>
                                                        ...
                                                        @can('Payments')
                                                            <li class="kt-menu__item  @if(Request::is('manager/payment*') ) kt-menu__item--active @endif"
                                                                aria-haspopup="true">
                                                                <a href="{{route('manager.payment.index')}}" class="kt-menu__link ">
                                                        ...
                                                        @endcan
                            @can('Join Us')
                                <li class="kt-menu__item @if(Request::is('manager/join_us*') ) kt-menu__item--active @endif"
                                    aria-haspopup="true">
                                    <a href="{{route('manager.join_us.index')}}" class="kt-menu__link ">
                                        <i class="kt-menu__link-icon flaticon2-layers-1"></i>
                                        <span class="kt-menu__link-text">{{ t('Join Us') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('Notification')
                            ...
                            @endcan
                            @canany(['General Settings', 'Transporters','Cities', 'Banks', 'Sliders', 'Pages', 'Managers', 'Roles'])
                                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel @if(Request::is('manager/settings*') || Request::is('manager/city*') || Request::is('manager/slider*') || Request::is('manager/testimonial*')) kt-menu__item--active @endif @if(Request::is('manager/roles*') ) kt-menu__item--active @endif @if(Request::is('manager/page*') ) kt-menu__item--active @endif"
                                    ...
                                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                                        <ul class="kt-menu__subnav">
                                            ...
                                            @can('Cities')
                                                <li class="kt-menu__item" aria-haspopup="true">
                                                    <a href="{{route('manager.city.index')}}" class="kt-menu__link">
                                                        <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="kt-menu__link-text">{{ t('Cities') }}</span>
                                                    </a>
                                                </li>
                                            @endcan
                                            @can('Banks')
                                                <li class="kt-menu__item" aria-haspopup="true">
                                                    <a href="{{route('manager.bank.index')}}" class="kt-menu__link">
                                                        <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="kt-menu__link-text">{{ t('Banks') }}</span>
                                                    </a>
                                                </li>
                                            @endcan
                                            ...
                                            @can('Transporters')
                                                <li class="kt-menu__item" aria-haspopup="true">
                                                    <a href="{{route('manager.transporter.index')}}"
                                                       class="kt-menu__link">
                                                        <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="kt-menu__link-text">{{ t('Transporters') }}</span>
                                                    </a>
                                                </li>
                                            @endcan
                                            ...
                                            @can('Nationality')
                                                <li class="kt-menu__item" aria-haspopup="true">
                                                    <a href="{{route('manager.nationality.index')}}"
                                                       class="kt-menu__link">
                                                        <i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                            <span></span>
                                                        </i>
                                                        <span class="kt-menu__link-text">{{ t('Nationality') }}</span>
                                                    </a>
                                                </li>
                                            @endcan
                                            @can('Sliders')
