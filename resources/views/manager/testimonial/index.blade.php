                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('manager.testimonial.create') }}" class="btn btn-danger btn-elevate btn-icon-sm">
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click','.deleteRecord',(function(){
                var id = $(this).data("id");
                var url = '{{ route("manager.testimonial.destroy", ":id") }}';
            ...
            $(function() {
                $('#users-table').DataTable({
                    ...
                    searching: false,
                    ajax: {
                        url : '{{ route('manager.testimonial.index') }}',
                        data: function (d) {
                            d.search = $("#search").val();
                        }
                    },
