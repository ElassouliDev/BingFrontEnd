                    ...
                    <form class="kt-form kt-form--fit kt-margin-b-20">
                        <div class="row kt-margin-b-20">
                            <div class="col-lg-2 kt-margin-b-10-tablet-and-mobile">
                                ...
                                <input type="text" name="name" id="name" class="form-control kt-input" placeholder="{{t('Package Name')}}">
                            </div>
            ...
            $(function() {
                $('#users-table').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'km_limit', name: 'km_limit'},
                        {data: 'draft_name', name: 'draft_name'},
