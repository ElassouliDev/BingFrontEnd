                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('manager.meal.create') }}" class="btn btn-danger btn-elevate btn-icon-sm">
                    ...
                    <form class="kt-form kt-form--fit kt-margin-b-20">
                        <div class="row kt-margin-b-20">
                            <div class="col-lg-2 kt-margin-b-10-tablet-and-mobile">
                                ...
                                <input type="text" name="name" id="name" class="form-control kt-input" placeholder="{{t('Meal Name')}}">
                            </div>
                            <div class="col-lg-2 kt-margin-b-10-tablet-and-mobile">
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click','.deleteRecord',(function(){
                var id = $(this).data("id");
                var url = '{{ route("manager.meal.destroy", ":id") }}';
            ...
            $('.branches').change(function () {
                var id = $(this).val();
                var url = '{{ route("manager.branchClassifications") }}';
                $.ajax({
                    type: "get",
                    url: url,
                    data: {
