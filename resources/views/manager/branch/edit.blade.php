    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="kt-portlet">
                ...
                <form enctype="multipart/form-data" id="form_information" class="kt-form kt-form--label-right" action="{{route('manager.branch.store') }}" method="post">
                    {{ csrf_field() }}
                    @if(isset($branch))
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        ...
                                                        <img id="blah"
                                                             @if(!isset($branch) || is_null($branch->getOriginal('image'))) style="display:none"
                                                             @endif src="{{ isset($branch) && !is_null($branch->getOriginal('image'))? url($branch->image):'' }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        ...
                                                        <img id="blah"
                                                             ...
                                                             @endif src="{{ isset($branch) && !is_null($branch->getOriginal('cover'))
 ? url($branch->cover):'' }}"
                                                             width="150" alt="No file chosen"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="merchant_id">
                                                        ...
                                                        @foreach($restaurants as $restaurant)
                                                            <option
                                                                value="{{$restaurant->id}}" {{isset($branch) && $branch->merchant_id == $restaurant->id ? 'selected':''}}>{{$restaurant->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
