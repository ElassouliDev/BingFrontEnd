                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('manager.merchant_type.create') }}" class="btn btn-danger btn-elevate btn-icon-sm">
                                    <i class="la la-plus"></i>
                                    {{t('Add Merchant Types')}}
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click','.deleteRecord',(function(){
                var id = $(this).data("id");
                var url = '{{ route("manager.merchant_type.destroy", ":id") }}';
            ...
            $(function() {
                $('#users-table').DataTable({
                    ...
                    searching: false,
                    ajax: {
                        url : '{{ route('manager.merchant_type.index') }}',
                        data: function (d) {
                            d.search = $("#search").val();
                        }
                    },
                    columns: [
                        ...
                        {data: 'name', name: 'name'},
                        {data: 'merchant_number', name: 'merchant_number'},
