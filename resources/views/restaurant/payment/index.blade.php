...
{{--                                <a href="{{ route('restaurant.payment.create') }}" class="btn btn-danger btn-elevate btn-icon-sm">--}}
...
{{--                    </div>--}}
                ...
                <div class="kt-portlet__body">
                    <form class="kt-form kt-form--fit kt-margin-b-20" action="{{route('restaurant.payment.index')}}" method="get">
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click','.deleteRecord',(function(){
                var id = $(this).data("id");
                var url = '{{ route("restaurant.payment.destroy", ":id") }}';
            ...
            $(function() {
                $('#users-table').DataTable({
                    ...
                    @endif
                    ajax: {
                        url : '{{ route('restaurant.payment.index') }}',
                        data: function (d) {
