                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('restaurant.meal.create') }}"
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.deleteRecord', (function () {
                var id = $(this).data("id");
                var url = '{{ route("restaurant.meal.destroy", ":id") }}';
            ...
            $(function () {
                $('#users-table').DataTable({
                    ...
                    searching: false,
                    ajax: {
                        url: '{{ route('restaurant.meal.index') }}',
                        data: function (d) {
                            d.name = $("#name").val();
            ...
            $('.branches').change(function () {
                var id = $(this).val();
                var url = '{{ route("restaurant.branchClassifications") }}';
                $.ajax({
                    type: "get",
                    url: url,
                    data: {
