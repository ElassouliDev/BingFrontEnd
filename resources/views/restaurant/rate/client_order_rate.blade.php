                            ...
                            <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
                                ...
                                <select class="form-control branches" name="branch" id="branch">
                                    ...
                                    @foreach($branches as $index=>$item)
                                        <option value="{{$item->id}}" {{$item->id == request()->brach? 'selected':''}}>{{$item->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-lg-3 kt-margin-b-10-tablet-and-mobile">
                                ...
                                <div class="input-group date">
                                    <input type="text" class="form-control date_time" name="date_start" readonly=""
                                           placeholder="{{t('Select date')}}" id="date_start">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.deleteRecord', (function () {
                var id = $(this).data("id");
                var url = '{{ route("restaurant.client_order_rate.destroy", ":id") }}';
