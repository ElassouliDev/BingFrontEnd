...
<header class="main-header home-5">
                    ...
                    <nav class="main-menu navbar-expand-md navbar-light">
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                <li class="active"><a href="index.html">{{w('Home')}}</a></li>
                                <li><a href="#about">{{w('About')}}</a></li>
                                <li><a href="{{route('join_us')}}">{{w('Contact')}}</a></li>
                                <li><a href="{{route('join_us')}}">{{w('Join us')}} </a></li>
                                <li><a href="rtl/index.html"><img src="{{w('images/su.svg')}}">Ar </a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
    ...
    <div class="sticky-header">
        <div class="container clearfix">
            <figure class="logo-box"><a href="index.html"><img src="{{w('images/logo2.svg')}}" alt=""></a></figure>
            <div class="menu-area">
