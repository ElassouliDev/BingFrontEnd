...
class DriverRateClientNotification extends Notification
{
    use Queueable;
    ...
    public function __construct(Order $order)
    {
        ...
        $this->message = [
            ...
            'title' => [
                'ar' => notification_trans("Driver Rate Client", [
                    'uuid' => $this->order->uuid
                ], 'ar'),
                'en' => notification_trans("Driver Rate Client", [
                    'uuid' => $this->order->uuid
                ], 'en'),
            ],
            'body' => [
                'ar' => notification_trans("Driver Rate Client", [], 'ar'),
                'en' => notification_trans("Driver Rate Client", [], 'en'),
            ],
