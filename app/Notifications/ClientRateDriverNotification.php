...
class ClientRateDriverNotification extends Notification
{
    use Queueable;
    ...
    public function __construct(Order $order)
    {
        ...
        $this->message = [
            ...
            'title' => [
                'ar' => notification_trans("Client Rate Driver", [
                    'uuid' => $this->order->uuid
                ], 'ar'),
                'en' => notification_trans("Client Rate Driver", [
                    'uuid' => $this->order->uuid
                ], 'en'),
            ],
            'body' => [
                'ar' => notification_trans("Client Rate Driver", [], 'ar'),
                'en' => notification_trans("Client Rate Driver", [], 'en'),
            ],
            'click_action' => "order_details_activity",
            'others' => [
                'type' => CLIENT_RATE_DRIVER_NOTIFICATION,
