        ...
        $this->message = [
            ...
            'title' => [
                'ar' => t('The Order', [
                    ...
                    'status' => getNotificationTypeName(ACCEPTED_ORDER_NOTIFICATION, 'ar'),
                ], 'ar'),
                'en' => t('The Order', [
                    'uuid' => optional($this->order)->uuid,
                    'status' => getNotificationTypeName(ACCEPTED_ORDER_NOTIFICATION, 'en'),
                ], 'en'),
            ],


            'body' => [
                'ar' => notification_trans("Your order accepted", [], 'ar'),
                'en' => notification_trans("Your order accepted", [], 'en'),
            ],
            'click_action' => "order_details_activity",
            'others' => [
                'type' => ACCEPTED_ORDER_NOTIFICATION,
