...
class ReadyOrderNotification extends Notification
{
    use Queueable;
        ...
        $this->message = [
            'title' => [
                'ar' => t('The Order', [
                    ...
                    'status' => getNotificationTypeName(READY_ORDER_NOTIFICATION, 'ar'),
                ], 'ar'),
                'en' => t('The Order', [
                    'uuid' => optional($this->order)->uuid,
                    'status' => getNotificationTypeName(READY_ORDER_NOTIFICATION, 'en'),
                ], 'en'),
            ],
            
            'body' => [
                'ar' => notification_trans("There is a new Order need delivery", [], 'ar'),
                'en' => notification_trans("There is a new Order need delivery", [], 'en'),
            ],
            'others' => [
