...
//            dd(checkRequestIsWorkingOrNot());
        ...
        return view('manager.order.index', compact('title', 'restaurants', 'total'));
    }
    ...
    public function show($id)
    {
        ...
        $delivery = $order->delivery_accept_or_on_way_or_completed;
        return view('manager.order.show', compact('order', 'title','delivery'));
    }
